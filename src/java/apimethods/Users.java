 ...
 */
@RAPIEnable(name = "Users", desc = "Manages clients lists and relations", url = "/API/Users/")
public class Users extends RAPIMethod {
    ...
    @Override
    @RGet(parameters = {}, returns = @RReturns(desc = "Le client", type = String.class))
    ...
    @Override
    @RPost(parameters = {@RParameter(name = "client name", desc = "Le nom du client", type = String.class)}, 
